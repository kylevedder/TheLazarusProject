...
terminal = os.getenv("HOME") .. "/bin/kitty"
...
-- Re-set tags and layouts when a screen's geometry changes
-- (e.g. different resolution)
screen.connect_signal("property::geometry", set_tags_and_layouts)

awful.screen.connect_for_each_screen(function(s)
    -- Wallpaper
    set_wallpaper(s)

    set_tags_and_layouts(s)
